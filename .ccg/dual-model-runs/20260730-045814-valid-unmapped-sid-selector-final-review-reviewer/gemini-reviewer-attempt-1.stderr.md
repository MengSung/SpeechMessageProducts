[codeagent-wrapper]
  Backend: gemini
  Command: gemini -o stream-json -y --include-directories D:\音訊科技產品\系統平台\SpeechMessageProducts\.worktrees\1.0.0.3.Gateway&Embedded.Worktree -p ﻿ROLE_FILE: [LOCAL_USER_PROFILE]\.claude\.ccg\prompts\gemini\reviewer.md
<TASK>
...
- If the task cannot be completed, explain the exact blocker.
  PID: 41768
  Log: [LOCAL_USER_PROFILE]\AppData\Local\Temp\codeagent-wrapper-41768.log
