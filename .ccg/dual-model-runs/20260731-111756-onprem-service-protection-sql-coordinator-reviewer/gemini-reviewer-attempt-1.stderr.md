[codeagent-wrapper]
  Backend: gemini
  Command: gemini -o stream-json -y --include-directories <worktree-root> -p ROLE_FILE: <user-home>\.claude\.ccg\prompts\gemini\reviewer.md
<TASK>
...
- If the task cannot be completed, explain the exact blocker.
  PID: 27904
  Log: <user-home>\AppData\Local\Temp\codeagent-wrapper-27904.log
