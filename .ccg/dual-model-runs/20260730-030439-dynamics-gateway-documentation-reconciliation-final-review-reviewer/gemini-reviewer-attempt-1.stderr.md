[codeagent-wrapper]
  Backend: gemini
  Command: gemini -o stream-json -y --include-directories D:\音訊科技產品\系統平台\SpeechMessageProducts\.worktrees\1.0.0.3.Gateway&Embedded.Worktree -p ﻿ROLE_FILE: C:\[LOCAL_WINDOWS_IDENTITY_REDACTED]\.claude\.ccg\prompts\gemini\reviewer.md
<TASK>
# CCG reviewer Task: dynamics-gateway-documentation-reconciliation-final-review
...
- If the task cannot be completed, explain the exact blocker.
  PID: 34772
  Log: C:\[LOCAL_WINDOWS_IDENTITY_REDACTED]\AppData\Local\Temp\codeagent-wrapper-34772.log
