[codeagent-wrapper]
  Backend: gemini
  Command: gemini -o stream-json -y --include-directories D:\音訊科技產品\系統平台\SpeechMessageProducts\.worktrees\1.0.0.3.Gateway&Embedded.Worktree -p ﻿ROLE_FILE: C:\Users\[LOCAL_PROFILE_REDACTED]\.claude\.ccg\prompts\gemini\reviewer.md
<TASK>
# CCG reviewer Task: development-workload-binding-set-final-review-retry
...
- If the task cannot be completed, explain the exact blocker.
  PID: 21864
  Log: C:\Users\[LOCAL_PROFILE_REDACTED]\AppData\Local\Temp\codeagent-wrapper-21864.log
