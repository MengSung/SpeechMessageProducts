# CCG reviewer Task: full-code-quality-audit-and-fix-review
...
- Secret-like values in appsettings diff are intentionally redacted in this prompt. The actual branch blanks active-looking checked-in secrets and adds environment-variable fallback where needed.
