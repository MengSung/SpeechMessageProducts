...
<TASK>
# CCG reviewer Task: dynamics-access-gateway-spec-final-recheck
...
- share `OrganizationAdmissionKey` capacity across old/new runtime generations,
  aliases for one organization, and blue/green/canary revisions, so reload or
  rollout cannot double aggregate Dynamics concurrency;
...
- If the task cannot be completed, explain the exact blocker.
  PID: 5436
  Log: C:\Users\Administrator\AppData\Local\Temp\codeagent-wrapper-5436.log
