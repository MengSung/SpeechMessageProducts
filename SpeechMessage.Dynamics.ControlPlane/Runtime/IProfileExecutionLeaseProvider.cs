// ============================================================================
// 檔案：SpeechMessage.Dynamics.ControlPlane/Runtime/IProfileExecutionLeaseProvider.cs
...
/// Runtime Lease 則固定本次呼叫使用的 Worker Executor／Process／Pipe Generation，兩者都不保存終端使用者
...
public interface IProfileExecutionLease : IAsyncDisposable, IDisposable
{
    ...
    /// <summary>
    /// 取得本次租約綁定的中立 Dynamics operation executor。呼叫端不得把 Executor 保存到租約生命週期之外，
    /// 否則 replace-and-drain 將無法證明舊 Generation 已無 Worker／Pipe 強引用。
    /// </summary>
