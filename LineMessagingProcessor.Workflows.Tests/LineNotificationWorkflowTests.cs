// ============================================================================
// AI-繁體中文檔案註解
// 檔案路徑：LineMessagingProcessor.Workflows.Tests/LineNotificationWorkflowTests.cs
// 所屬區塊：LINE 共用 workflow 模組與測試，放置可跨產品重用的訊息處理流程。
// 檔案責任：此檔案屬於測試範圍，註解重點在說明測試意圖、固定的回歸條件，以及避免未來重構時誤改既有契約。
// 主要型別：class LineNotificationWorkflowTests、class CapturingHttpMessageHandler
// 主要成員：SendAsync_posts_text_message_through_processor、SendAsync_posts_image_message_created_by_product_friendly_wrapper、SendAsync_posts_flex_message_created_by_product_friendly_wrapper、SendAsync_posts_text_v2_message_created_by_product_friendly_wrapper、SendAsync_posts_coupon_message_created_by_product_friendly_wrapper、SendAsync_posts_text_message_with_quick_reply_created_by_product_friendly_factories、SendAsync_posts_confirm_template_message_created_by_product_friendly_wrapper、SendAsync_posts_buttons_template_message_created_by_product_friendly_wrapper、SendAsync_posts_carousel_template_message_created_by_product_friendly_wrapper、SendAsync_posts_image_carousel_template_message_created_by_product_friendly_wrapper
// 引用命名空間：System.Net、System.Text、FluentAssertions、Line.Messaging、LineMessagingProcessor、LineMessagingProcessor.Workflows、Newtonsoft.Json.Linq、Xunit
