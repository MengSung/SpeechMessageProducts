...
public class MemberInfoCommitmentTypeSortTests
{
    ...
    public void OrderRows_Ascending_UsesConfiguredRankThenUnknownThenEmpty()
    {
        ...
        result.Select(row => row.ContactId).Should().Equal("pastor", "member", "unknown", "empty");
    }
    ...
    public void OrderRows_Descending_ReversesConfiguredRanksOnly()
    {
        ...
        result.Select(row => row.ContactId).Should().Equal("member", "pastor", "unknown", "empty");
    }
    ...
    public void OrderRows_SameRankUsesOrdinalNameThenCaseInsensitiveContactId()
    {
        ...
        result.Select(row => row.ContactId).Should().Equal("beta", "a-id", "B-id", "z-id");
    }
    ...
    public void BuildSegments_UsesConfiguredSequenceAndKeepsUnknownAndEmptyLast()
    {
        ...
        result.Should().Equal(
            new MemberInfoCommitmentTypeSegment(MemberInfoCommitmentTypeSegmentKind.Configured, 100000006, 2),
            new MemberInfoCommitmentTypeSegment(MemberInfoCommitmentTypeSegmentKind.Configured, 1, 3),
            new MemberInfoCommitmentTypeSegment(MemberInfoCommitmentTypeSegmentKind.Unknown, null, 4),
            new MemberInfoCommitmentTypeSegment(MemberInfoCommitmentTypeSegmentKind.Empty, null, 1));
    }
    ...
    public void BuildSegments_DescendingReversesOnlyConfiguredSegments()
    {
        ...
        result.Select(segment => segment.Value).Should().Equal(1, 100000006, null, null);
    }
    ...
    public void PlanSlices_CrossesConfiguredUnknownAndEmptySegments()
    {
        var segments = new[]
        {
            new MemberInfoCommitmentTypeSegment(MemberInfoCommitmentTypeSegmentKind.Configured, 100000006, 3),
            new MemberInfoCommitmentTypeSegment(MemberInfoCommitmentTypeSegmentKind.Unknown, null, 2),
            new MemberInfoCommitmentTypeSegment(MemberInfoCommitmentTypeSegmentKind.Empty, null, 4)
        };

        var result = MemberInfoCommitmentTypeSort.PlanSlices(2, 5, segments);

        result.Should().Equal(
            new MemberInfoCommitmentTypeSlice(MemberInfoCommitmentTypeSegmentKind.Configured, 100000006, 2, 1),
            new MemberInfoCommitmentTypeSlice(MemberInfoCommitmentTypeSegmentKind.Unknown, null, 0, 2),
            new MemberInfoCommitmentTypeSlice(MemberInfoCommitmentTypeSegmentKind.Empty, null, 0, 2));
    }
    ...
    public void PlanSlices_EmptyOrOutOfRangeRequestReturnsNoSlices(int skip, int take)
    {
        var segments = new[]
        {
            new MemberInfoCommitmentTypeSegment(MemberInfoCommitmentTypeSegmentKind.Configured, 1, 10)
        };

        MemberInfoCommitmentTypeSort.PlanSlices(skip, take, segments).Should().BeEmpty();
    }
