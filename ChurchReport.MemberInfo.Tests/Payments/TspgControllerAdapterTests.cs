// ============================================================================
// AI-繁體中文檔案註解
// 檔案路徑：ChurchReport.MemberInfo.Tests/Payments/TspgControllerAdapterTests.cs
// 所屬區塊：ChurchReport 會員、付款與 LINE 共用流程的測試專案，用來固定產品層行為與回歸案例。
// 檔案責任：此檔案屬於測試範圍，註解重點在說明測試意圖、固定的回歸條件，以及避免未來重構時誤改既有契約。
// 主要型別：class TspgControllerAdapterTests、class RecordingPaymentGateway、class ThrowingToolUtilityProvider
// 主要成員：Constructor_accepts_common_post_payment_workflow_dependencies、ResultUrl_calls_payment_gateway_and_returns_core_json_acknowledgement、PostBack_calls_payment_gateway_before_product_workflow、CreatePayment_calls_payment_gateway_create_with_taishin_profile、QueryOrderStatus_calls_payment_gateway_query、CreateController、CreatePaymentAsync、QueryPaymentAsync、ParseCallbackAsync、GetToolUtility
// 引用命名空間：System.Text、ChurchReport.Controllers、ChurchReport.Payments、ChurchReport.Services、FluentAssertions、Microsoft.AspNetCore.Http、Microsoft.AspNetCore.Mvc、Microsoft.Extensions.Configuration
