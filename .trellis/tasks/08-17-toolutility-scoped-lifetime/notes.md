...
以下是刪除前對 7 個死碼型別與 `RegisterManager` 執行三項查核的原始輸出。`(a)` 的
建立／宣告／繼承 pattern 對所有型別均無外部建立；`(b)` 的非註解文字搜尋仍會列出型別
自身宣告、同檔內方法名稱、Debug 字串與 namespace，因此在輸出後以實際語意判讀，不把
這些文字誤認為外部型別引用。
...
(no matches)
===== DedicationInfo (b) =====
./SpeechMessageProducts.ChurchReport/Models/DedicationInfoModel.cs:21:    public class DedicationInfoModel
./SpeechMessageProducts.ChurchReport/Models/DedicationInfoModel.cs:23:        public DedicationInfoModel()
./SpeechMessageProducts.ChurchReport/WebServiceConnector/DedicationInfo.cs:29:    public class DedicationInfo
./SpeechMessageProducts.ChurchReport/WebServiceConnector/DedicationInfo.cs:39:        public DedicationInfo()
./SpeechMessageProducts.ChurchReport/WebServiceConnector/DedicationInfo.cs:46:        public DedicationInfoModel InitializeDedicationInfoModel()
./SpeechMessageProducts.ChurchReport/WebServiceConnector/DedicationInfo.cs:50:                var model = new DedicationInfoModel();
===== DedicationInfo (c) =====
./SpeechMessageProducts.ChurchReport/Views/Home/DedicationInofView.cshtml:2:@model DedicationInfoModel
./SpeechMessageProducts.ChurchReport/Views/Home/DedicationInofView.cshtml:7:<form data-ajax="true" data-ajax-begin="onBegin" data-ajax-success="onSuccess" asp-action="SaveDedicationInfo" asp-controller="Home" method="post">
./SpeechMessageProducts.ChurchReport/Views/Home/DedicationInofView.cshtml:71:        @(Html.DevExtreme().Form<DedicationInfoModel>()
===== EquipmentStatusCalculator (a) =====
(no matches)
===== EquipmentStatusCalculator (b) =====
./SpeechMessageProducts.ChurchReport/WebServiceConnector/EquipmentStatusCalculator.cs:27:    public class EquipmentStatusCalculator
./SpeechMessageProducts.ChurchReport/WebServiceConnector/EquipmentStatusCalculator.cs:32:        public EquipmentStatusCalculator()
===== EquipmentStatusCalculator (c) =====
(no matches)
===== HappyGroupUtility (a) =====
(no matches)
===== HappyGroupUtility (b) =====
./SpeechMessageProducts.ChurchReport/WebServiceConnector/HappyGroupUtility.cs:37:    public class HappyGroupUtility
===== HappyGroupUtility (c) =====
(no matches)
===== LineBindingUtility (a) =====
(no matches)
===== LineBindingUtility (b) =====
./SpeechMessageProducts.ChurchReport/WebServiceConnector/LineBindingUtility.cs:40:    public class LineBindingUtility
./SpeechMessageProducts.ChurchReport/WebServiceConnector/NewPerson.cs:639:                    System.Diagnostics.Debug.WriteLine($"[LineBindingUtility.CopyVistorCardInfo] 成功設定信仰狀態: {aNewContact.FaithStatus} -> {spiritualIdentityValue}");
./SpeechMessageProducts.ChurchReport/WebServiceConnector/NewPerson.cs:648:                    System.Diagnostics.Debug.WriteLine($"[LineBindingUtility.CopyVistorCardInfo] 設定信仰狀態失敗: {ex.Message}");
./SpeechMessageProducts.ChurchReport/WebServiceConnector/PersonalInfomatioManager.cs:368:                    System.Diagnostics.Debug.WriteLine($"[LineBindingUtility.CopyVistorCardInfo] 成功設定信仰狀態: {aNewContact.FaithStatus} -> {spiritualIdentityValue}");
./SpeechMessageProducts.ChurchReport/WebServiceConnector/PersonalInfomatioManager.cs:377:                    System.Diagnostics.Debug.WriteLine($"[LineBindingUtility.CopyVistorCardInfo] 設定信仰狀態失敗: {ex.Message}");
./SpeechMessageProducts.ChurchReport/WebServiceConnector/PersonalInfomatioManager.cs:925:                    System.Diagnostics.Debug.WriteLine($"[LineBindingUtility.CopyVistorCardInfo] 成功設定信仰狀態: {aPersonalInfomationViewModel.Status} -> {spiritualIdentityValue}");
./SpeechMessageProducts.ChurchReport/WebServiceConnector/PersonalInfomatioManager.cs:934:                    System.Diagnostics.Debug.WriteLine($"[LineBindingUtility.CopyVistorCardInfo] 設定信仰狀態失敗: {ex.Message}");
===== LineBindingUtility (c) =====
(no matches)
===== UploadData (a) =====
(no matches)
===== UploadData (b) =====
./SpeechMessageProducts.ChurchReport/Models/ListSmallGroupWeeklyReport.cs:97:            m_UploadIntegrateData.UploadData(aSelectedDate, Account, Password, LoginType, GroupType, ListEntityId, ref WeeklyReportEntityId, SundayPrayers, aSmallGroupData, ref WeeklyReportData, ref WeeklyReportAnalysis, HappyWeekIndex, HappyWeekTopic, PauseCheckBox);
./SpeechMessageProducts.ChurchReport/WebServiceConnector/UploadData.cs:37:    public class UploadData
./SpeechMessageProducts.ChurchReport/WebServiceConnector/UploadIntegrateData.Core.cs:92:        public void UploadData(
===== UploadData (c) =====
(no matches)
===== WebServiceConnector (a) =====
(no matches)
===== WebServiceConnector (b) =====
命中均為 ChurchReport.WebServiceConnector namespace、using 或 Payment NamingTests 的 namespace/path 字串，沒有 new、變數宣告或繼承。
===== WebServiceConnector (c) =====
(no matches)
===== RegisterConnector (a) =====
(no matches)
===== RegisterConnector (b) =====
./SpeechMessageProducts.ChurchReport/Models/RegisterManager.cs:29:            RegisterConnector aRegisterConnector = new RegisterConnector();
./SpeechMessageProducts.ChurchReport/WebServiceConnector/NewPerson.cs:706:                System.Diagnostics.Debug.WriteLine($"[RegisterConnector.ConvertIndexToSpiritualIdentity] 輸入值: {Value}, 回傳文字: {displayText}");
./SpeechMessageProducts.ChurchReport/WebServiceConnector/PersonalInfomatioManager.cs:763:                System.Diagnostics.Debug.WriteLine($"[RegisterConnector.ConvertIndexToSpiritualIdentity] 輸入值: {SpiritualIdentity}, 回傳文字: {displayText}");
===== RegisterConnector (c) =====
(no matches)
===== RegisterManager (a) =====
(no matches)
===== RegisterManager (b) =====
./SpeechMessageProducts.ChurchReport/Models/RegisterManager.cs:25:    public class RegisterManager
===== RegisterManager (c) =====
(no matches)
```

`RegisterConnector` 的唯一建立者是同一段輸出中的 `RegisterManager.cs:29`，而
`RegisterManager` 自己沒有呼叫者，故為可一併刪除的死鏈；`DedicationInfoModel` 與
`UploadIntegrateData.UploadData` 只是同名子字串，並非刪除目標的型別引用。

```text
NamingTests Type.GetType 查核
ChurchReport.MemberInfo.Tests/Payments/DonationPaymentFormModelNamingTests.cs:45:        var formModelType = Type.GetType("ChurchReport.Models.DonationPaymentFormModel, ChurchReport");
ChurchReport.MemberInfo.Tests/Payments/DonationPaymentReturnProcessorNamingTests.cs:31:        var processorType = Type.GetType("ChurchReport.Tools.DonationFeePaymentProcessor, ChurchReport");
ChurchReport.MemberInfo.Tests/Payments/DonationPaymentProcessorNamingTests.cs:34:        var processorType = Type.GetType("ChurchReport.WebServiceConnector.DonationPaymentProcessor, ChurchReport");
ChurchReport.MemberInfo.Tests/Payments/DonationPaymentManagerNamingTests.cs:30:        var managerType = Type.GetType("ChurchReport.Models.DonationPaymentManager, ChurchReport");
```

上述 NamingTests 的全部 `Type.GetType` 命中均不含 DedicationInfo、EquipmentStatusCalculator、
HappyGroupUtility、LineBindingUtility、UploadData、WebServiceConnector、RegisterConnector 或
RegisterManager；22 個既有失敗測試亦已在下方完整測試中重新執行並維持基準。

### 實際刪除與保留

已刪除：`DedicationInfo.cs`、`EquipmentStatusCalculator.cs`、`HappyGroupUtility.cs`、
`LineBindingUtility.cs`、`UploadData.cs`、`WebServiceConnector.cs`、`RegisterConnector.cs`、
`RegisterManager.cs`。

`ListManagementDataManager` 型別保留，僅刪除無呼叫者的 `discoveryServiceType` 建構式。
`DonationPaymentProcessor` 型別保留，刪除帶有 Factory 呼叫的無呼叫者三參數建構式；兩個
只轉送到它且無呼叫者的 wrapper 亦隨之刪除。為了不修改測試，保留單一 adapter 的 public
相容簽章，該簽章僅供 `RuntimeHelpers.GetUninitializedObject` 測試替身通過編譯，若實際執行
即 fail-closed 丟出 `NotSupportedException`，不會重新引入 Factory 或未管理連線。
...
```text
dotnet test ToolUtility.Tests/ToolUtility.Tests.csproj
已通過! - 失敗:     0，通過:    63，略過:     0，總計:    63，持續時間: 1 s - ToolUtility.Tests.dll (net10.0)
EXIT=0
```

```text
dotnet test ToolUtility.Dataverse.Tests/ToolUtility.Dataverse.Tests.csproj
已通過! - 失敗:     0，通過:    11，略過:     0，總計:    11，持續時間: 1 s - ToolUtility.Dataverse.Tests.dll (net10.0)
EXIT=0
```
...
第一次完整建置曾報出 `DonationPaymentProcessorKeyInNotificationTests.cs:300,340` 的 CS1729，
因兩個測試替身需要單一 adapter base constructor 來通過編譯；依上述相容 shim 修正後，第二次
建置已 0 警告/0 錯誤。未改動測試。
...
SpeechMessageProducts.ChurchReport/Models/DedicationInfoModel.cs:21:    public class DedicationInfoModel
SpeechMessageProducts.ChurchReport/WebServiceConnector/NewPerson.cs:639:                    System.Diagnostics.Debug.WriteLine($"[LineBindingUtility.CopyVistorCardInfo] ...");
SpeechMessageProducts.ChurchReport/WebServiceConnector/NewPerson.cs:706:                System.Diagnostics.Debug.WriteLine($"[RegisterConnector.ConvertIndexToSpiritualIdentity] ...");
SpeechMessageProducts.ChurchReport/WebServiceConnector/PersonalInfomatioManager.cs:368:                    System.Diagnostics.Debug.WriteLine($"[LineBindingUtility.CopyVistorCardInfo] ...");
SpeechMessageProducts.ChurchReport/WebServiceConnector/PersonalInfomatioManager.cs:763:                System.Diagnostics.Debug.WriteLine($"[RegisterConnector.ConvertIndexToSpiritualIdentity] ...");

git diff --check
（無輸出）
```

刪除後統計：A 7、B 19、C 0；需遷移的可執行 Factory 呼叫剩 26，連同 4 處註解文字總數為 30。
沒有選擇 B 類方向、沒有遷移 A/B 呼叫點、沒有改動 `InMemoryDataContextSmallGroup` 的 13 個
session cache。人工回歸：等待人工回歸。
