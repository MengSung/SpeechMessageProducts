...
- [ ] Both source and target worktrees are clean before merge.
- [ ] The target contains the source commit after merge.
- [ ] MemberInfo focused tests and repository verification complete with results recorded.
