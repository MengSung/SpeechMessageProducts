// ============================================================================
// AI-繁體中文檔案註解
// 檔案路徑：ToolUtility/EntityOperations/EntityOptimizedQueryService.cs
// 所屬區塊：ChurchReport 共用工具與整合輔助層，包含通知、付款、CRM 或跨模組 helper。
// 檔案責任：此檔案位於服務或工具層，註解重點在說明共用責任、外部依賴、錯誤傳遞與呼叫端應遵守的前置條件。
// 主要型別：class EntityOptimizedQueryService、class PagedResult
// 主要成員：RetrieveEntity、RetrieveEntityAsync、RetrieveByCondition、RetrieveByConditionAsync、RetrieveByFieldValue、RetrieveByFieldValueAsync、RetrievePagedAsync、LogQueryPerformance、HasStateCodeCondition、SafeLogError
// 引用命名空間：System、System.Collections.Generic、System.Diagnostics、System.Linq、System.Threading、System.Threading.Tasks、Microsoft.Xrm.Sdk、Microsoft.Xrm.Sdk.Query
