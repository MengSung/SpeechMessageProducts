...
namespace ToolUtilityNameSpace
{
    ...
    {
        #region 資料區
        public IOrganizationService m_OrganizationService;
        ...
        public IOrganizationService SetOrganizationService()
        {
            ...
            using (loServiceProxy = new OrganizationServiceProxy(loOrgConfigInfo, loCreds))
            {
                ...
                m_OrganizationService = (IOrganizationService)loServiceProxy;
            }
        ...
        public Guid RetrieveContactIdByAccountNumber(String AccountNumber, String aPassword)
        {
            try
            {
                lock (m_RetrieveContactLocker)
        ...
        public EntityCollection RetrieveManyToOneCollection()
        {
            try
            {
                lock (m_QueryManyToOneLocker)
                {
                    ...
                    EntityCollection result1 = this.m_OrganizationService.RetrieveMultiple(query1);
        ...
        public Guid CreateEntity(ref IOrganizationService aOrganizationService, Entity aEntityTobeToCreate)
        {
            try
            {
                lock (m_EntityLocker)
    ...
    public class AuthenticateWithNoHelp
    {
        ...
        /// </summary>
        /// 
        OrganizationServiceProxy m_OrganizationProxy;
        ...
        public void Run()
        {
            ...
            if (!String.IsNullOrWhiteSpace(organizationUri))
            {
                ...
                using ( m_OrganizationProxy =
                    GetProxy<IOrganizationService, OrganizationServiceProxy>(orgServiceManagement, credentials))
                {
                    // This statement is required to enable early-bound type support.
                    m_OrganizationProxy.EnableProxyTypes();

                    // Now make an SDK call with the organization service proxy.
                    // Display information about the logged on user.
                    Guid userid = ((WhoAmIResponse)m_OrganizationProxy.Execute(
        ...
        public String RetrieveContactByAccountNumber(String AccountNumber, String aPassword)
        {
            try
            {
                lock (m_RetrieveContactLocker)
                {
                    ...
                    //Console.WriteLine("除錯 002");
                    //  Query passed to the service proxy
                    EntityCollection retrieved = this.m_OrganizationProxy.RetrieveMultiple(querybyexpression);
