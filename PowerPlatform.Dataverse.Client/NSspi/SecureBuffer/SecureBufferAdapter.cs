// ============================================================================
// AI-繁體中文檔案註解
// 檔案路徑：PowerPlatform.Dataverse.Client/NSspi/SecureBuffer/SecureBufferAdapter.cs
// 所屬區塊：Power Platform Dataverse Client 與低階連線支援程式庫，包含外部 SDK 或協定相容程式碼。
// 檔案責任：此檔案位於資料存取或 CRM 整合層，註解重點在說明查詢條件、資料來源、欄位對應與交易/一致性假設。
// 主要型別：class SecureBufferAdapter
// 主要成員：ExtractData、Dispose、Handle
// 引用命名空間：System、System.Collections.Generic、System.Runtime.ConstrainedExecution、System.Runtime.InteropServices
