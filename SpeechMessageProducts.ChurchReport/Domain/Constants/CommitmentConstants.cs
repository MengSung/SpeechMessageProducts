// ============================================================================
// AI-繁體中文檔案註解
// 檔案路徑：ChurchReport/Domain/Constants/CommitmentConstants.cs
// 所屬區塊：ChurchReport 主網站與後台應用程式，承載控制器、模型、CRM 整合、付款流程、LINE 通知與產品層商業規則。
// 檔案責任：此檔案提供 CommitmentConstants 相關功能，註解重點在說明檔案責任、上游/下游依賴與維護時不可破壞的行為假設。
// 主要型別：class CommitmentType、class Gender、class FollowUpWeek、class FollowUpResult、class FollowUpNextStep、class CareConstants
// 主要成員：GetDisplayName、RequiresCare、ShouldCountInAttendance、NumberToWeekCode、WeekCodeToChineseNumber、NumberToChineseWeek
