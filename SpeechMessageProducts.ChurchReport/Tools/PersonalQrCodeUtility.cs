...
{
    public class PersonalQrCodeUtility : IDisposable
    {
        #region 資料區
        #region 參數資料
        ...
        #region 初始化
        /// <summary>
        /// 建立個人 QR Code 工具，使用呼叫端目前 request scope 的 ToolUtility。
        /// 此 ToolUtility 由呼叫端的 request scope 提供，本型別不擁有、不釋放。
        /// </summary>
        /// <param name="toolUtility">目前 request scope 的 ToolUtility。</param>
        public PersonalQrCodeUtility(ToolUtilityClass toolUtility)
        {
