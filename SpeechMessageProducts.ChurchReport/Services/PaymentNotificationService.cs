// ============================================================================
// AI-繁體中文檔案註解
// 檔案路徑：ChurchReport/Services/PaymentNotificationService.cs
// 所屬區塊：ChurchReport 主網站與後台應用程式，承載控制器、模型、CRM 整合、付款流程、LINE 通知與產品層商業規則。
// 檔案責任：此檔案位於服務或工具層，註解重點在說明共用責任、外部依賴、錯誤傳遞與呼叫端應遵守的前置條件。
// 主要型別：class PaymentNotificationService
// 主要成員：BuildPaymentLineRetryKey、SendLineMessage、SendLineNotificationByType、SendLineFailureNotificationByType、GetLineChannelAccessToken、CreateDefaultLineNotificationWorkflow
// 引用命名空間：System、System.Collections.Generic、System.IO、ChurchReport.Payments、ChurchReport.Tools、Line.Messaging、LineMessagingProcessor、LineMessagingProcessor.Workflows
