// ============================================================================
// AI-繁體中文檔案註解
// 檔案路徑：ChurchReport/WebServiceConnector/UploadIntegrateData.PresentRecord.cs
// 所屬區塊：ChurchReport 主網站與後台應用程式，承載控制器、模型、CRM 整合、付款流程、LINE 通知與產品層商業規則。
// 檔案責任：此檔案位於服務或工具層，註解重點在說明共用責任、外部依賴、錯誤傳遞與呼叫端應遵守的前置條件。
// 主要型別：class UploadIntegrateData
// 主要成員：CreatePresentRecordList、ConvertAttributeToExpectedTypeUsingMetadata、CreatePresentRecordListByList、CreatePresentRecord、ConvertAttributeToExpectedType、UpdatePresentRecord、UpdateSinglePresentRecord、SetupPresentRecordEntityAttributes、SetupLeaderReferences、SetupAttendanceAttributes
// 引用命名空間：System、System.ServiceModel、System.Text.RegularExpressions、System.Collections.Generic、ChurchReport.Models、ChurchReport.Models.CrmTransmitModule、Microsoft.Xrm.Sdk
