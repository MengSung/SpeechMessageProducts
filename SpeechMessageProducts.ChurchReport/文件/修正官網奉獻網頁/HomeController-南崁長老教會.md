    ...
    public class HomeController : Controller, IDisposable
    {
        ...
        public async System.Threading.Tasks.Task<IActionResult> Login()
        {
            try
            {
                ...
                images.Add(Url.Content("~/assets/images/南崁長老教會歡迎圖-250px.png"));
                images.Add(Url.Content("~/assets/images/南崁長老教會主日時間-250px.png"));
            ...
            catch (System.Exception e)
            {
                ...
                await aLineMessagingProcessorClass.SendMessage("U7638e4ed509708a3573ba6d69970583d", "南崁基督長老教會: 錯誤 => " + ErrorString);
        ...
        public async System.Threading.Tasks.Task<IActionResult> QPayLogin()
        {
            try
            {
                ...
                // 官網整合串連金流奉獻跑馬燈
                images.Add(Url.Content("~/assets/images/奉獻圖檔-250px.png"));
                images.Add(Url.Content("~/assets/images/南崁長老教會歡迎圖-250px.png"));
                images.Add(Url.Content("~/assets/images/南崁長老教會主日時間-250px.png"));
                images.Add(Url.Content("~/assets/images/nankan_001.jpg"));
        ...
        public ActionResult EquipmentView()
        {
            ...
            catch (System.Exception e)
            {
                ...
                aLineMessagingProcessorClass.SendMessage("U7638e4ed509708a3573ba6d69970583d", "南崁基督長老教會 : 綁定錯誤 => " + ErrorString);
        ...
        public async Task<IActionResult> SavePoll(PollModel aPollModel)
        {
            ...
            catch (System.Exception e)
            {
                ...
                aLineMessagingProcessorClass.SendMessage("U7638e4ed509708a3573ba6d69970583d", "南崁基督長老教會 : => " + ErrorString);
