...
$mermaidPath = [System.IO.Path]::Combine($scriptDir, 'payment-flow-complete-v15-learning.mmd')
$outputPath = [System.IO.Path]::Combine($scriptDir, 'payment-flow-complete-v15-learning.png')
...
$script:g.DrawString('V15 Complete Payment Call Flow - Learning Layout', $titleFont, $script:textBrush, 920, 34)
$script:g.DrawString('Fixed-lane layout: product host, ASP.NET adapter, reusable core, providers, and product post-payment workflow. Lines are routed through gutters to avoid covering text.', $subtitleFont, $script:captionBrush, 500, 94)

Draw-Group 80 180 930 5120 'ChurchReport product host' '#fff7ed' '#c2410c'
Draw-Group 1065 180 930 5120 'ASP.NET host adapters' '#ecfeff' '#0891b2'
Draw-Group 2050 180 930 5120 'SpeechMessage.Payments core' '#eef2ff' '#4f46e5'
Draw-Group 3035 180 930 5120 'Provider implementations' '#f0fdf4' '#16a34a'
Draw-Group 80 5360 3885 350 'Reusable boundary summary' '#f8fafc' '#64748b'
...
Draw-Node 'E3' $xP 4600 $w $h $productFill $productStroke
Draw-Node 'E4' $xP 4820 $w $h $productFill $productStroke
Draw-Node 'E5' $xP 5040 $w $h $productFill $productStroke
Draw-Node 'E6' $xP 5260 $w $h $productFill $productStroke
Draw-Node 'E7' $xP 5480 $w $h $summaryFill $summaryStroke
Draw-Node 'F1' 180 5480 1120 160 $coreFill $coreStroke
Draw-Node 'F2' 1540 5480 1120 160 $adapterFill $adapterStroke
Draw-Node 'F3' 2900 5480 900 160 $productFill $productStroke
...
Draw-Arrow 'D1' 'B' 'D4' 'T'
Draw-Arrow 'D4' 'B' 'D5' 'T'
Draw-Arrow 'D1' 'B' 'D6' 'T'
Draw-Arrow 'D6' 'B' 'D7' 'T'
Draw-Arrow 'D3' 'L' 'C3' 'R'
Draw-Arrow 'D5' 'L' 'C3' 'R'
Draw-Arrow 'D7' 'L' 'C3' 'R'
Draw-Arrow 'C3' 'L' 'A7' 'R'
Draw-Arrow 'A7' 'B' 'A8' 'T'
Draw-Arrow 'A8' 'R' 'A9' 'L'
Draw-ArrowVia 'A9' 'B' 'A10' 'T' @([pscustomobject]@{ X = 3500; Y = 3450 }, [pscustomobject]@{ X = 545; Y = 3450 })
...
Draw-ArrowVia 'C7' 'B' 'E5' 'R' @([pscustomobject]@{ X = 2515; Y = 4970 }, [pscustomobject]@{ X = 980; Y = 4970 })
