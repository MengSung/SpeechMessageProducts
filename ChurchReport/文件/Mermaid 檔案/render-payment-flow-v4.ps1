...
if (-not ('PaymentFlowPngWriterV4' -as [type])) {
...
public static class PaymentFlowPngWriterV4
{
...
$outputPath = [System.IO.Path]::Combine($scriptDir, 'payment-flow-clear-v4.png')
$width = 3200
$height = 4600
...
Draw-Group 1540 2480 1480 900 'Post-payment product implementation' '#fff7ed' '#c2410c'
...
Draw-Node 'w1' 1700 2670 500 150 'IPaymentRecordUpdater' "Reusable abstraction for updating a product payment record." '#ffedd5' '#c2410c'
Draw-Node 'w2' 2300 2670 500 150 'IPaymentPayerNotifier' "Reusable abstraction for notifying the payer." '#ffedd5' '#c2410c'
Draw-Node 'w3' 1700 3000 500 150 'ChurchReport updater' "Updates CRM payment bill or donation record." '#ffedd5' '#c2410c'
Draw-Node 'w4' 2300 3000 500 150 'ChurchReport notifier' "Sends LINE notification. Future products can use email or SMS." '#ffedd5' '#c2410c'
...
Draw-Line 'w1' 'B' 'w3' 'T'
Draw-Line 'w2' 'B' 'w4' 'T'
Draw-Polyline @((EdgePoint 'w3' 'L'), [pscustomobject]@{X=1510;Y=3075}, [pscustomobject]@{X=1510;Y=3495}, (EdgePoint 'n13' 'R'))
Draw-Polyline @((EdgePoint 'w4' 'L'), [pscustomobject]@{X=1510;Y=3075}, [pscustomobject]@{X=1510;Y=3495}, (EdgePoint 'n13' 'R'))

if ([System.IO.File]::Exists($outputPath)) {
    [System.IO.File]::Delete($outputPath)
}

[PaymentFlowPngWriterV4]::Save($bitmap, $outputPath)
