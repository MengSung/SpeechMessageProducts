...
if (-not ('PaymentFlowPngWriterV6' -as [type])) {
...
public static class PaymentFlowPngWriterV6
{
...
$outputPath = [System.IO.Path]::Combine($scriptDir, 'payment-flow-clear-v6.png')
$width = 3200
$height = 4600
...
[PaymentFlowPngWriterV6]::Save($bitmap, $outputPath)
