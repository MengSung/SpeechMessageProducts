    ...
    public class HomeController : Controller, IDisposable
    {
        ...
        public async System.Threading.Tasks.Task<IActionResult> Login()
        {
            try
            {
                ...
                images.Add(Url.Content("~/assets/images/dhchurch-001.jpg"));
                images.Add(Url.Content("~/assets/images/dhchurch-002.jpg"));
            ...
            catch (System.Exception e)
            {
                ...
                await aLineMessagingProcessorClass.SendMessage("U7638e4ed509708a3573ba6d69970583d", "東湖禮拜堂: 錯誤 => " + ErrorString);
        ...
        public async Task<IActionResult> SavePoll(PollModel aPollModel)
        {
            ...
            catch (System.Exception e)
            {
                ...
                aLineMessagingProcessorClass.SendMessage("U7638e4ed509708a3573ba6d69970583d", "東湖禮拜堂 : => " + ErrorString);
