...
namespace ChurchReport.Controllers
{
    public class HomeController : Controller, IDisposable
    {
        ...
        public HomeController(IHttpContextAccessor httpContextAccessor, IMemoryCache memoryCache, IPayment qpayService)
        {
            ...
            m_PaymentService = qpayService; // DI 容器自動注入 QPayToolkitWrapper
        ...
        public async System.Threading.Tasks.Task<IActionResult> Login()
        {
            ...
            catch (System.Exception e)
            {
                ...
                await aLineMessagingProcessorClass.SendMessage("U7638e4ed509708a3573ba6d69970583d", "聖谷行道會: 錯誤 => " + ErrorString);
        ...
        public async Task<IActionResult> ProcessLogin(GalleryViewModel aGalleryViewModel)
        {
            ...
            catch (System.Exception e)
            {
                ...
                aLineMessagingProcessorClass.SendMessage("U7638e4ed509708a3573ba6d69970583d", "聖谷行道會: 錯誤 => " + ErrorString);
        ...
        #region 官網整合串連金流奉獻登入
        //[CheckSessionOut]
        public async System.Threading.Tasks.Task<IActionResult> QPayLogin()
        {
            try
            {
                var images = new List<string>();
        ...
        [HttpPost]
        public async Task<IActionResult> ProcessQPayLogin(GalleryViewModel aGalleryViewModel)
        {
            try
            {
                if (aGalleryViewModel.FullName != null && aGalleryViewModel.Mobile != null && aGalleryViewModel.NationId != null)
                {
                    ...
                    String QueryResult = "";
                    Entity aLoginContact = m_InMemoryDataContextSmallGroup.QpayManager.GetLoginContactQpay(aGalleryViewModel, ref QueryResult);
                ...
                {
                    return Json(new { status = "3", message = "喔喔!所有欄位都必須填寫喔，感謝您!"  });
                }
            ...
            try
            {
                ...
                if (LoginParameter != "AccountPassword")
                {
                    ...
                    if(m_InMemoryDataContextSmallGroup.ListManager.LoginType == "個人回報" )
                    {
                        ...
                        // 轉到個人相關資訊
                        return RedirectToAction("PersonalInfomationView");
                    }
                    else
                    {
        ...
        public IActionResult UpdateSmallGroupPresentRecord(string key, string values)
        {
            try
            {
                ...
                Task.Factory.StartNew(() => m_InMemoryDataContextSmallGroup.ListManager.m_ListSmallGroupWeeklyReport.m_SmallGroupDataList.m_AllMemeberData.UpdateMember(key, values), TaskCreationOptions.LongRunning);
        ...
        public async Task<IActionResult> SaveIntegrate(string WeeklyReportData, String HappyWeekIndex, String HappyWeekTopic, String CheckBox)
        {
            try
            {
                ...
                if (m_InMemoryDataContextSmallGroup.ListManager.m_ListSmallGroupWeeklyReport.m_SmallGroupDataList.m_SmallGroupData.Members != null)
                {
        ...
        public ActionResult EquipmentView()
        {
            try
            {
                ...
                // 設定裝備清單資料
                m_InMemoryDataContextSmallGroup.EquipmentDataManager.SetupEquipmentData(m_InMemoryDataContextSmallGroup.AppointmentsListManager.m_Account, m_InMemoryDataContextSmallGroup.AppointmentsListManager.m_Password);
            ...
            catch (System.Exception e)
            {
                ...
                aLineMessagingProcessorClass.SendMessage("U7638e4ed509708a3573ba6d69970583d", "聖谷行道會 : 綁定錯誤 => " + ErrorString);
        ...
        [HttpGet]
        public object LoadEquipmentList(DataSourceLoadOptions loadOptions)
        {
            try
            {
                if (m_InMemoryDataContextSmallGroup.EquipmentDataManager.m_EquipmenRoot != null)
                {
                    return DataSourceLoader.Load(m_InMemoryDataContextSmallGroup.EquipmentDataManager.m_EquipmenRoot.EquipmenSmallGroupList, loadOptions);
                }
                else { return null; }
            }
            catch (System.Exception e)
        ...
        public object LoadEquipmentContact(string id, DataSourceLoadOptions loadOptions)
        {
            try
            {
                if (m_InMemoryDataContextSmallGroup.EquipmentDataManager.m_EquipmenRoot.EquipmenSmallGroupList != null)
                {
                    //var tasks = m_InMemoryDataContextSmallGroup.HappyGroupDataManager.m_ActiveHappyGroupListClass.HappyGroupWeeklyReportListClass.Where(e => e.ListEntityId == id).Select(e => e.HappyGroupWeeklyReportList).FirstOrDefault();
                    var tasks = m_InMemoryDataContextSmallGroup.EquipmentDataManager.m_EquipmenRoot.EquipmenSmallGroupList.Where(e => e.SmallGroupListEntityId == id).Select(e => e.EquipmentContactList).FirstOrDefault();
        ...
        public object LoadEquipmentStorLessons(string id, DataSourceLoadOptions loadOptions)
        {
            try
            {
                ...
                EquipmenSmallGroup aEquipmenSmallGroup = m_InMemoryDataContextSmallGroup.EquipmentDataManager.GetEquipmenSmallGroupByContactId(id);

                if (aEquipmenSmallGroup != null)
                {
                    var tasks = aEquipmenSmallGroup.EquipmentContactList.Where(e => e.EquipmentContactId == id).Select(e => e.StorLessonsList).FirstOrDefault();
        ...
        public void SetFeeManagerViewBag()
        {
            try
            {
                ...
                ViewBag.Colume24 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson16;
                ViewBag.Colume25 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson17;
                ViewBag.Colume26 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson18;
                ViewBag.Colume27 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson19;
                ViewBag.Colume28 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson20;
                ViewBag.Colume29 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson21;
                ViewBag.Colume30 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson22;
                ViewBag.Colume31 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson23;
                ViewBag.Colume32 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson24;
                ViewBag.Colume33 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson25;
                ViewBag.Colume34 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson26;
                ViewBag.Colume35 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson27;
                ViewBag.Colume36 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson28;
                ViewBag.Colume37 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson29;
                ViewBag.Colume38 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.Lesson30;

                ViewBag.Colume39 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.HomeWorkA;
                ViewBag.Colume40 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.HomeWorkB;
                ViewBag.Colume41 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.HomeWorkC;
                ViewBag.Colume42 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.HomeWorkD;
                ViewBag.Colume43 = m_InMemoryDataContextSmallGroup.FeeList.m_ClassName.HomeWorkE;
            }
            catch (System.Exception e)
            {
                string ErrorString = "錯誤訊息 : FullName = " + GetType().FullName.ToString() + " , Time = " + DateTime.Now.ToString() + " , Description = " + e.ToString();
        ...
        public IActionResult QrCodeGetLineId(string DisplayName, string UserLineId, string GroupId, string RoomId, string ViewType)
        {
            try
            {
                ...
                m_ToolUtilityClass.TraceByLevel(TOTAL_LEVEL, LEVEL_1, "001 : 聖谷行道會: 資訊 => " + DisplayName + "，" + UserName);
                ...
                m_ToolUtilityClass.TraceByLevel(TOTAL_LEVEL, LEVEL_1, "002: 聖谷行道會: 資訊 => " + DisplayName + "，" + ClassName + "，" + UserName + "，" + ClassIndex + "，" + OnboardType);
        ...
        public async Task<IActionResult> SavePoll(PollModel aPollModel)
        {
            ...
            catch (System.Exception e)
            {
                ...
                aLineMessagingProcessorClass.SendMessage("U7638e4ed509708a3573ba6d69970583d", "聖谷行道會 : => " + ErrorString);
        ...
        #endregion
        #region  工作人員主動掃描聯絡人的QR CODE 簽到、簽退 (Line Liff)
        [Route("/Home/PersonalQrCodeView/{QrCodeViewPatameter}")]
        public ActionResult PersonalQrCodeView(String QrCodeId, string QrCodeViewPatameter)
        {
            try
            {
                #region 控制 Navigation 下拉項目
        ...
        [HttpPost]
        public IActionResult PersonalQrCodeGetLineId(string DisplayName, string UserLineId, string GroupId, string RoomId, string ViewType)
        {
            try
            {
                m_InMemoryDataContextSmallGroup.LineBindingViewModel.LineUserId = m_InMemoryDataContextSmallGroup.AppointmentsListManager.LineUserId = UserLineId;
                ...
                PersonalQrCodeUtility aPersonalQrCodeUtility = new PersonalQrCodeUtility();
                ...
                // 主日掃描後的相關設定
                aPersonalQrCodeUtility.SetupQrCodeIdString(m_InMemoryDataContextSmallGroup.ListManager.QrCodeId, DisplayName, UserLineId, ref SundayName, ref CategoryName, ref UserName, ref OnboardType);
