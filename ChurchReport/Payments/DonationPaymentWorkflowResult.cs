// ============================================================================
// AI-繁體中文檔案註解
// 檔案路徑：ChurchReport/Payments/DonationPaymentWorkflowResult.cs
// 所屬區塊：ChurchReport 主網站與後台應用程式，承載控制器、模型、CRM 整合、付款流程、LINE 通知與產品層商業規則。
// 檔案責任：此檔案位於付款相關流程，註解重點在說明 provider 邊界、金流狀態、錯誤處理與不可改變的外部契約。
// 主要型別：record DonationPaymentWorkflowResult
// 主要成員：ShopNo、PayToken、OrderNo、ProviderTransactionId、Amount、AmountMinorUnits、ProductEntityId、PaymentOrganization、PaymentCategory、PayType
