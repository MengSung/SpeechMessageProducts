// ============================================================================
// AI-繁體中文檔案註解
// 檔案路徑：ChurchReport/Models/CrmTransmitModule/TransmitMemberInfomation.cs
// 所屬區塊：ChurchReport 主網站與後台應用程式，承載控制器、模型、CRM 整合、付款流程、LINE 通知與產品層商業規則。
// 檔案責任：此檔案位於資料模型或 ViewModel 層，註解重點在說明欄位語意、序列化/繫結用途與相容性限制。
// 主要型別：class GroupWeeklyReportGuid、class AccountPasswordData、class MemberInfomation、class MemberInfomationPackage、class WeeklyReport、class NewContact
// 主要成員：WeeklyReportGuid、GroupName、SmallGroupLeaderName、SmallGroupDate、SundayPresentRate、SmallGroupRate、Account、Password、Group、Name
