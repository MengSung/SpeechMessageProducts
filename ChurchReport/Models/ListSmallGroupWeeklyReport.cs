...
namespace ChurchReport.Models
{
    public class ListSmallGroupWeeklyReport
    {
        ...
        public String LoginType { get; set; } // 回報型式: 領袖 OR 個人回報
        public String GroupType { get; set; } = "一般小組"; // 小組型式: "一般小組" OR "幸福小組"
        public String SmallGroupLeaderContactId { get; set; } // 領袖 ID
        public String SmallGroupLeaderFullName { get; set; } // 領袖姓名
