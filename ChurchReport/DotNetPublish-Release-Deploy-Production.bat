...
REM 將 Git 版本號轉換為有效的 NuGet 版本格式
REM 移除非數字字符，確保格式為 Major.Minor.Patch
set VERSION=%GIT_VERSION%

echo [版本] Git: %GIT_VERSION%
echo [時間] %date% %time%
echo.

REM 清理舊的輸出
if exist "./bin/Output-Release-Deploy-Production" (
    echo [清理] 清理舊版本...
    rmdir /s /q "./bin/Output-Release-Deploy-Production"
)
...
dotnet publish -c Release -r win-x64 --self-contained false ^
    ...
    -o "./bin/Output-Release-Deploy-Production"
