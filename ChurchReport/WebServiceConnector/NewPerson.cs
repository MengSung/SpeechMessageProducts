    ...
    public class NewPerson
    {
        ...
        public String FilterNewContact(AccountPasswordData aAccountPasswordData, ref NewContact aNewContact)
        {
            try
            {
                ...
                {
                    // 這是要新建立的連絡人
                    return CreateNewContactInCrm2011(aAccountPasswordData, ref aNewContact);
                }
            }
        ...
        public String CreateNewContactInCrm2011(AccountPasswordData aAccountPasswordData, ref NewContact aNewContact)
        {
            try
            {
                ...
                // 設定連絡人相關屬性
                SetupNewContactParameter(ref aNewContactEntity, aAccountPasswordData, ref aNewContact);
        ...
        private void SetupNewContactParameter(ref Entity aNewContactEntity, AccountPasswordData aAccountPasswordData, ref NewContact aNewContact)
        {
