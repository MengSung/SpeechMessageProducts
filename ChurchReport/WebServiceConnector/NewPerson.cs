    ...
    public class NewPerson
    {
        ...
        private void FindListCollection()
        {
            try
            {
                ...
                EntityCollection aListEntityCollection = m_ToolUtilityClass.QueryListByContactId(m_ContactId, "new_contact_family_leader_list");  // 小組長/共同組長
