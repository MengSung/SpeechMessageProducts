...
namespace ChurchReport.WebServiceConnector
{
    public class QPayProcessor
    {
        ...
        //private const String RETURN_URL = "https://rpgback.speechmessage.com.tw:470/api/QPayCard/QPayReturnUrl";
        ...
        // 客製化
        private const String QPAY_ORGANIZATION = "rpg";
        ...
        public async Task<string> CreateFeeAsync(Entity LineLoginContact, QpayModel QpayModel)
        {
            try
            {
                m_LineMessagingClient.GetFollowersIdAsync();
