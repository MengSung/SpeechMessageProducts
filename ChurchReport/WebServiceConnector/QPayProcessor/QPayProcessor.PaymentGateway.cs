...
namespace ChurchReport.WebServiceConnector
{
    ...
    public partial class QPayProcessor
    {
        ...
        /// </summary>
        /// <param name="aShopNo">商店代號（例如：DA3009_001）</param>
        /// <returns>HashCode 字串（格式：A1,A2,B1,B2）</returns>
        ...
        /// <summary>
        /// 從 appsettings.json 讀取指定商店的 HashCode
        /// </summary>
        private string GetHashCodeFromConfiguration(string shopNo)
        {
            try
            {
                ...
                // ✅ 支援多商店配置（未來擴充）
                // 可以在 appsettings.json 中新增 "AdditionalShops" 區段
        ...
        /// <summary>
        /// 備用的 HashCode 對照表（當配置檔讀取失敗時使用）
        /// ⚠️ 建議將這些值移至 appsettings.json 的 AdditionalShops 區段
        /// </summary>
