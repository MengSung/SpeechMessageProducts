...
namespace ChurchReport.WebServiceConnector
{
        ...
        private void FindLoginUser(String Account, String Password)
    {
                        ...
                        if (aIdentity != "10. 未入組結案")
                        {
                            ...
                            (
                                new Member
                                {
                                    ...
                                    #endregion
                                    #region 靈修、晨、晚禱
                                    SpiritualWork = aSpiritualWork, // 靈修次數
        ...
        private void SetSmallGroupData( ref ListSmallGroupWeeklyReport aListSmallGroupWeeklyReport)
        {
            ...
            {
                if (aMember.Status.Contains("牧師師母") || aMember.Status.Contains("區長") || aMember.Status.Contains("區牧") || aMember.Status.Contains("小組長") || aMember.Status.Contains("小組同工") || aMember.Status.Contains("小組組員"))
                {
