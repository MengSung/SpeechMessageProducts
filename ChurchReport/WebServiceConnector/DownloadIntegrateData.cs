...
namespace ChurchReport.WebServiceConnector
{
        ...
        private void FindLoginUser(String Account, String Password)
    {
        ...
        private void SetSmallGroupData( ref ListSmallGroupWeeklyReport aListSmallGroupWeeklyReport)
        {
            ...
            {
                if (aMember.Status.Contains("牧師師母") || aMember.Status.Contains("區長") || aMember.Status.Contains("區牧") || aMember.Status.Contains("小組長") || aMember.Status.Contains("共同組長") || aMember.Status.Contains("小組組員"))
                {
